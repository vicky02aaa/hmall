 ...
 */
@Service
@RequiredArgsConstructor // 利用Lombok自动生成包含所有final字段的构造函数，实现依赖注入
...
/*    private final RestTemplate restTemplate;
    ...
    private void handleCartItems(List<CartVO> vos) {
        ...
        // 2.3 利用RestTemplate发起http请求,远程调用查询商品接口，获取商品详情列表
        ...
        List<ItemDTO> items = response.getBody();*/ //负责均衡
        List<ItemDTO> items = itemClient.queryItemByIds(itemIds); //基于openFeigh实现负责均衡简化
